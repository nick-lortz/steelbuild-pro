...
const DaysIndicator = ({ targetDate }) => {
  ...
  try {
    ...
    if (daysRemaining < 0) {
      return (
        <div className="inline-flex items-center gap-1 text-xs text-red-400 font-semibold">
          <Clock size={12} />
            ...
            {projects.map((project) => {
              ...
              return (
                ...
                >
                  ...
                  {/* PM */}
                  <td className="px-3 py-3">
                    <span className="text-xs text-foreground truncate max-w-[100px] inline-block">
