...
/**
 * WCAG 4.1.3 Compliant Toast Wrapper
 * Ensures status messages are announced to assistive technology
 */

// Create a live region container if it doesn't exist
