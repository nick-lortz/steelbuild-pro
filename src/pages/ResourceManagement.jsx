...
export default function ResourceManagement() {
  ...
  return (
    <div>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          <CardTitle className="text-slate-50 text-lg font-semibold tracking-tight">Resource Details ({filteredResources.length})</CardTitle>
        </CardHeader>
        <CardContent>
                ...
                <tbody>
                  {filteredResources.map((resource) =>
                    <tr key={resource.id} className="border-b border-zinc-800 hover:bg-zinc-800/50">
                      ...
                      <td className="text-slate-50 px-4 py-3">
                        <Badge variant="outline" className="text-slate-50 px-2.5 py-0.5 text-xs font-semibold capitalize rounded-md inline-flex items-center border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
                          {resource.type}
                        </Badge>
                      </td>
                      <td className="py-3 px-4">
