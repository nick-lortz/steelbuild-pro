    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <aside
        ...
        <div className="h-16 flex items-center px-5 border-b border-border flex-shrink-0">
          ...
          <span className="font-semibold text-lg tracking-tight ml-3 text-foreground">SteelBuild Pro</span>
        </div>
            ...
            return (
              <div key={group.name}>
                ...
                <button
                  ...
                  className={cn(
                    'w-full flex items-center justify-between px-3 py-2 text-[10px] font-semibold uppercase tracking-wider transition-smooth rounded-md',
                    hasActivePage ? 'text-primary' : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'
                  )}
                >
                  <div className="flex items-center gap-2">
                    <GroupIcon size={13} />
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            'flex items-center gap-2.5 px-3 py-2 text-[13px] font-medium transition-smooth rounded-md',
                            isActive
        ...
        <div className="border-t border-border p-3 flex-shrink-0 bg-muted/30">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-muted/50 transition-smooth rounded-md">
      ...
      <main id="main-content" className="lg:ml-64 pt-16 lg:pt-0 min-h-screen pb-20 lg:pb-0 bg-background" role="main">
